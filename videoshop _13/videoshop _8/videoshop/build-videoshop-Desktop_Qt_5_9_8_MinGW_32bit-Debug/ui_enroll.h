...
public:
    ...
    void setupUi(QDialog *enroll)
    {
        ...
        radioButton = new QRadioButton(enroll);
        radioButton->setObjectName(QStringLiteral("radioButton"));
        radioButton->setGeometry(QRect(150, 120, 100, 30));
        radioButton_2 = new QRadioButton(enroll);
        radioButton_2->setObjectName(QStringLiteral("radioButton_2"));
        radioButton_2->setGeometry(QRect(250, 120, 100, 30));
    ...
    void retranslateUi(QDialog *enroll)
    {
        ...
        radioButton->setText(QApplication::translate("enroll", "\347\224\267", Q_NULLPTR));
        radioButton_2->setText(QApplication::translate("enroll", "\345\245\263", Q_NULLPTR));
    } // retranslateUi
